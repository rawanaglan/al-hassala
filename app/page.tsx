    ...
    >
      ...
      <header className="relative z-20 border-b border-[#d4af37]/30 bg-white/80 backdrop-blur-xl">
        <div className="mx-auto flex max-w-7xl items-center justify-between px-6 py-5 lg:px-10">
          ...
          {/* Desktop Navigation */}
          <nav className="hidden items-center gap-4 text-sm font-semibold text-[#8c6d31] md:flex">
            <Link
              href="/"
            ...
            {user ? (
              ...
              <Link
                href="/login"
                className="btn-gold-3d rounded-full px-5 py-2.5 text-xs font-bold ms-4"
              >
                تسجيل الدخول
              </Link>
            )}
          ...
          <div className="flex items-center gap-3 md:hidden">
            <Link
              href="/"
              className="btn-gold-3d inline-flex items-center justify-center rounded-xl px-4 py-2 text-xs font-bold"
            >
              الرئيسية
            </Link>
            <Link
